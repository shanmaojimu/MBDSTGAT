...
from utils.dataload import load_selfVR_data_cross_subject, load_HGD_data_cross_subject, \
    load_bciciv2a_data_cross_subject, load_selfImage_single_subject, load_selfVedio_single_subject, \
    load_physionet_data_single_subject, load_bci2b_npy_data_single_subject
...
def start_run(args):
    ...
    # save_loss_gap = '/home/fafu/lrq/EEG/KGAT-Mamba/loss_gap/leaveone/2a'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-epochs', type=int, default=275, help='Number of epochs to train.')
    ...
    parser.add_argument('-log_path', type=str, default='/root/',
                        help='The log files path.')
    parser.add_argument('-model_path', type=str, default='/root/',
                        help='Path of saved model.')
    parser.add_argument('-result_path', type=str, default='/root/',
                        help='Path of result.')
    parser.add_argument('-spatial_adj_path', type=str, default='/root/',
                        help='Path of saved spatial_adj.')
    parser.add_argument('-time_adj_path', type=str, default='/root/',
    ...
    parser.add_argument('-father_path', type=str, default='/root/')

    parser.add_argument('-tensorboard_path', type=str, default='/root/',
