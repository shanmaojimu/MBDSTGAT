...
from models.None_SSTG_TP import None_SSTG_TP
...
def start_run(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('None SSTG&TP : best_acc:{} best_kappa:{}'.format(best_acc, best_kappa))
    ...
    # save_loss_gap = '/home/fafu/lrq/EEG/KGAT-Mamba/loss_gap/2a/1,3,9/None SSTG&TP'
