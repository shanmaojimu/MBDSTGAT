...
from models.None_SSTG import None_SSTG
...
def start_run(args):
    ...
    save_loss_gap = '/home/fafu/lrq/EEG/KGAT-Mamba/loss_gap/HGD1/12/None SSTG'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-adj_edge_change_ratio', type=float, default=0.2,
