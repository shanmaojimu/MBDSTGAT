...
from utils.dataload import load_HGD_single_subject, from utils.run_epoch import train_one_epoch, evaluate_one_epoch
...
def start_run(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('None DSCA&TP : best_acc:{} best_kappa:{}'.format(best_acc, best_kappa))
    ...
    save_loss_gap = '/home/fafu/lrq/EEG/KGAT-Mamba/loss_gap/2a/1,3,9/None DSCA&TP'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-father_path', type=str,
                        default='/home')
