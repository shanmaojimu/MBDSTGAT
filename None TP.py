...
from models.None_TP import None_TP
...
def start_run(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('None TP : best_acc:{} best_kappa:{}'.format(best_acc, best_kappa))
    ...
    save_loss_gap = '/home/fafu/lrq/EEG/KGAT-Mamba/loss_gap/HGD1/12/None TP'
